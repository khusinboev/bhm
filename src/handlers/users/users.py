...
async def start_cmd1(message: Message):
    await message.answer("Natijangizni buyurtma qilish uchun <b>'Abituriyent ruxsatnomasi'</b>ni <b>PDF</b> faylini yuboring",
    ...
    try:
        ...
        if check_status:
            ...
            await bot.send_message(chat_id=user_id,
                                   text="Natijangizni buyurtma qilish uchun <b>'Abituriyent ruxsatnomasi'</b>ni <b>PDF</b> faylini yuboring",
...
@user_router.message(F.document, F.chat.type == "private")
...
@user_router.message(F.photo, F.chat.type == "private")
